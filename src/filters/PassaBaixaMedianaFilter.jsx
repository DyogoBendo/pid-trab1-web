...
export default function PassaBaixaMedianaFilter() {
  ...
  const handleProcessClick = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/process/passa_baixa_mediana?kernel_size=${kernelSize}`, {
        method: 'POST',
        body: formData,
      });
    ...
    <div>
      ...
      {originalImage && (
        <div className="side-by-side-container">
          ...
          <div className="image-column">
            <h3>Processada (Cinza + Mediana)</h3>
            {processedImage ? (
